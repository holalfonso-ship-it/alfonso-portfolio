...
const Hero: React.FC = () => {
  ...
  return <section id="home" className="min-h-screen flex flex-col justify-center items-center px-6 md:px-12 py-32 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(50%_50%_at_50%_50%,rgba(var(--primary-rgb),0.1)_0%,rgba(var(--primary-rgb),0)_100%)]" style={{
      ...
      <div className="max-w-7xl w-full mx-auto z-10 opacity-0 animate-fade-in animation-delay-200">
        ...
        <div className="mt-8 md:mt-12 opacity-0 animate-slide-up animation-delay-1200">
          <a href="#projects" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-primary text-primary-foreground font-medium transition-transform hover:scale-105 active:scale-95" onClick={handleScrollClick}>
            View my work
          </a>
        </div>
      </div>
