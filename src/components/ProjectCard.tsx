...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div 
      ref={cardRef}
      className={cn(
        "group relative h-full cursor-pointer transition-all duration-700 opacity-0 transform translate-y-12",
    ...
    >
      ...
      >
        <div className="relative h-full overflow-hidden rounded-2xl bg-muted">
          ...
          <div 
            className={cn(
              "absolute bottom-0 left-0 right-0 p-6 md:p-8 transition-transform duration-500 ease-out",
          ...
          >
            ...
            <p 
              className={cn(
                "text-sm text-white/80 max-w-md opacity-0 transform translate-y-4 transition-all duration-500",
