    ...
    <section id="case-study" className="py-32 md:py-40 px-6 md:px-12 bg-gradient-to-b from-background to-background/95">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col space-y-6 mb-16 md:mb-24">
          ...
          <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tight max-w-3xl">
            <AnimatedText text="Scaling Design Excellence at Leadtech" className="inline-block" once />
          </h2>
