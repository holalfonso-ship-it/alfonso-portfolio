    ...
    <section id="case-study" className="py-32 md:py-40 px-6 md:px-12 bg-gradient-to-b from-background to-background/95">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="py-[60px] md:py-[120px]">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-muted-foreground mb-6 block">
            The Problem
          </span>
        ...
        {/* ── TASK ── */}
        <div className="py-[60px] md:py-[120px] border-t border-border/20">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-muted-foreground mb-6 block">
            The Goal
          </span>
        ...
        {/* ── ACTION ── */}
        <div className="py-[60px] md:py-[120px] border-t border-border/20">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-muted-foreground mb-10 block">
            Action
          </span>
          <h3 className="text-3xl md:text-4xl font-display font-bold tracking-tight mb-16">
            Merging DesignOps, AI & Data Intelligence
          </h3>

          <div className="space-y-16 md:space-y-20">
            {actionMilestones.map((milestone, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-[3fr_7fr] gap-4 md:gap-12 items-start">
                <h4 className="text-2xl md:text-3xl font-display font-semibold tracking-tight">
                  {milestone.title}
                </h4>
                <p className="text-muted-foreground text-lg md:text-xl leading-relaxed">
        ...
        <div className="py-[60px] md:py-[120px] border-t border-border/20">
          ...
          <blockquote className="border-l-2 border-primary/40 pl-6 max-w-2xl">
            ...
            <cite className="text-muted-foreground text-sm italic not-italic">
